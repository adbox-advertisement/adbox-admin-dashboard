...
import { editorPageToCms, editorSettingsToCms } from "./mappers"
...
export async function loadRdiCms(signal?: AbortSignal): Promise<CmsSnapshot> {
  const [site, pages] = await Promise.all([
    superAdminApi.get<CmsSiteResponse>("/cms/sites/rdi", { params: { view: "draft" }, signal }),
